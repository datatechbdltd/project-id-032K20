...
@push('title') Flight details @endpush
@push('description')
                        ...
                        <div class="sidebar single-content-sidebar mb-0">
                            <div class="sidebar-widget single-content-widget">
                                ...
                                <div class="btn-box pt-2">
                                    <a href="{{ route('frontend.flightBooking') }}" class="theme-btn text-center w-100 mb-2"><i class="la la-shopping-cart mr-2 font-size-18"></i>Book Now</a>
