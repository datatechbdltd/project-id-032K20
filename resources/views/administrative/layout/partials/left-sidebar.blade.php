...
<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
    ...
    <div class="brand flex-column-auto" id="kt_brand">
        <!--begin::Logo-->
        <a href="{{ route('administrative.dashboard.index') }}" class="brand-logo">
            <img alt="Logo" src="{{ asset('assets/administrative/media/logos/logo-light.png') }}" />
        </a>
        <!--end::Logo-->
        <!--begin::Toggle-->
    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
            ...
            <ul class="menu-nav">
                ...
                {{--Users--}}
                <li class="menu-item @if(Request::is('*/user')) menu-item-active @endif" aria-haspopup="true">
                    <a href="{{ route('administrative.user.index') }}" class="menu-link">
						<span class="svg-icon menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <polygon points="0 0 24 0 24 24 0 24"/>
               ...
               {{--Vendors--}}
                <li class="menu-item @if(Request::is('*/provider')) menu-item-active @endif" aria-haspopup="true">
                    <a href="{{ route('administrative.provider.index') }}" class="menu-link">
                        ...
                        <span class="menu-text">{{__('Providers')}}</span>
                    </a>
                </li>
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item menu-item-submenu @if(Request::is('*/language')) menu-item-open menu-item-here @elseif(Request::is('*/language/*')) menu-item-open menu-item-here @endif" aria-haspopup="true" data-menu-toggle="hover">
                                ...
                                <div class="menu-submenu">
                                    ...
                                    <ul class="menu-subnav">
                                        <li class="menu-item @if(Request::is('*/language')) menu-item-active @endif" aria-haspopup="true">
                                            <a href="{{ route('administrative.language.index') }}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
                                                    <span></span>
                                                </i>
                                        ...
                                        <li class="menu-item @if(Request::is('*/language/create')) menu-item-active @endif" aria-haspopup="true">
                                            <a href="{{ route('administrative.language.create') }}" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
                                                    <span></span>
                                                </i>
